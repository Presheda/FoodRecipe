...
public class HealthLabelAdapter extends RecyclerView.Adapter<HealthLabelAdapter.IngridientViewHolder> {
    Context mContext;
    ...
    public HealthLabelAdapter(Context context, List<String> stringList) {
        mContext = context;
        mStringList = stringList;
    }
